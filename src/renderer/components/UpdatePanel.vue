...
<style scoped>
.app-update { display: grid; grid-template-columns: minmax(0, 1fr) auto; align-items: center; gap: 8px 12px; border: 1px solid #d0d7de; border-radius: 9px; padding: 10px; background: #f6f8fa; color: #24292f; }
header { grid-column: 1 / -1; display: flex; justify-content: space-between; align-items: center; gap: 12px; font-size: 13px; font-weight: 600; }
header i { color: #0969da; margin-right: 4px; }
small { color: #7a889b; font-size: 10px; font-variant-numeric: tabular-nums; font-weight: 400; white-space: nowrap; }
...
button { grid-column: 2; grid-row: 2; border: 1px solid var(--accent, #0aa19e); border-radius: 6px; background: var(--accent, #0aa19e); color: #fff; font: inherit; font-size: 12px; padding: 7px 10px; cursor: pointer; }
